...
const ErrorMessageBoxForgorPassword = (message) => {
  ...
  return (
    <>
      {isClicked && (
        <div
          className="flex flex-col justify-center bg-red-100 border border-red-900 text-red-800 px-4 py-3 rounded relative mt-6"
          role="alert"
        >
...
export default ErrorMessageBoxForgorPassword;
